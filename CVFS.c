...
void ManPageDisplay(char Name[])
{
    ...
    {
        printf("About : It is used to delete exiting file\n");
        printf("Usage : unlink File File_name\n");
...
//  Description :       It is used to display all deatail of 
//                      all files
//  Input :             None
//  Output :            None
//  Author :            Yash Pralhad Patil
...
//                      specific files
//  Input :             File name 
//  Output :            Exite status of function
//  Author :            Yash Pralhad Patil
//  Date :              2/08/2026
//
//////////////////////////////////////////////////////
...
} //End of unlick_file function

//////////////////////////////////////////////////////
//
//  Function Name :     write_file()
//  Description :       It is used to write
//                      the data into specific file
//  Input :             file Descriptor ,data we want to write ,size of data
...
//  Description :       It is used to reat
//                      the data from specific file
            ...
            )
{
    ...
    // Read the data
    strncpy(data,uareaobj.UFDT[fd]->ptrinode->Buffer + uareaobj.UFDT[fd]->ReadOffset, size);  // tyachtya pulun wach
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            {
                iRet = unlink_file(Command[1]);         //user Define function unlink is allready define
            ...
            else if(strcmp(Command[0],"write") == 0)
            {
                ...
                if (iRet == ERR_INVALID_PARAMETER)
                {
                    ...
                    printf("Please refer man page for information\n");
                }
        ...
        else if(iCount == 3)
        {
            ...
            else if(strcmp(Command[0], "read") == 0)
            {
                ...
                if (iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : Invaliud parameter\n");
                }
                else if (iRet == ERR_FILE_NOT_EXIST)
                {
                    printf("Error : File not exit\n");
